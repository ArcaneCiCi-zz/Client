...
import net.minecraft.client.audio.generator.NoiseGeneratorOctaves;
import net.minecraft.client.blocks.Block;
import net.minecraft.client.blocks.impl.BlockSand;
...
import net.minecraft.client.world.impl.*;
import net.minecraft.client.world.map.MapGenBase;
import net.minecraft.client.world.map.MapGenCavesHell;

import java.util.Random;

public class ChunkProviderHell implements IChunkProvider {

    private final Random field_4170_h;
    ...
    private final World field_4164_n;
    private final MapGenBase field_4159_s;
