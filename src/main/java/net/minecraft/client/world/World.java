...
import net.minecraft.client.entity.mob.render.SpawnerAnimals;
...
import net.minecraft.client.world.chunk.impl.ChunkCache;
import net.minecraft.client.world.chunk.impl.ChunkCoordIntPair;
import net.minecraft.client.world.chunk.impl.ChunkProviderLoadOrGenerate;
...
public class World
    ...
    private final List field_1051_z;
    private final List field_1024_A;
    ...
    private final ArrayList field_9428_I;
    private final Set field_9427_K;
    ...
    public float getLightBrightness(int i, int j, int k) {
        return Client.getInstance().getModManager().getFullbrightModule().isEnabled() ? 0.85F : worldProvider.lightBrightnessTable[getBlockLightValue(i, j, k)];
    }
