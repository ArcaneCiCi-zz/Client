...
import net.minecraft.client.misc.MCHashTable;
import net.minecraft.client.network.manager.NetClientHandler;
import net.minecraft.client.network.packet.impl.Packet255KickDisconnect;
import net.minecraft.client.network.packet.impl.Packet59ComplexEntity;
import net.minecraft.client.world.World;
import net.minecraft.client.world.chunk.IChunkProvider;
import net.minecraft.client.world.chunk.impl.ChunkProviderClient;
...
public class WorldClient extends World {
    ...
    private final boolean scheduledTickSet;
