...
import net.minecraft.client.entity.player.render.RenderPlayer;
...
public class ItemRenderer {
    ...
    private final RenderBlocks field_1357_e;
    ...
    public void renderItemInFirstPerson(float f) {
        ...
        GL11.glPopMatrix();
        float f2 = mc.theWorld.getLightBrightness(MathHelper.floor_double(entityplayersp.posX), MathHelper.floor_double(entityplayersp.posY), MathHelper.floor_double(entityplayersp.posZ));
