...
import net.minecraft.client.item.impl.*;
...
public class Item {
    ...
    public static Item recordCat = (new ItemRecord(2001, "cat")).setIconIndex(241); // the best music disc though
    ...
    protected Item(int i) {
        ...
        if (itemsList[256 + i] != null) {
            System.out.println((new StringBuilder()).append("CONFLICT @ ").append(i));
        }
