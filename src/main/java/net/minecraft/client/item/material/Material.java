package net.minecraft.client.item.material;


import net.minecraft.client.item.material.impl.MaterialLiquid;
import net.minecraft.client.item.material.impl.MaterialLogic;
import net.minecraft.client.item.material.impl.MaterialTransparent;
...
public class Material {
    ...
    public static final Material unused = new Material(); // maybe remove this later
