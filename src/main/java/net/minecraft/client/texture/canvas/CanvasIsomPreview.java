...
import net.minecraft.client.misc.OsMap;
import net.minecraft.client.render.impl.IsoImageBuffer;
import net.minecraft.client.texture.TerrainTextureManager;
import net.minecraft.client.thread.ThreadRunIsoClient;
import net.minecraft.client.world.World;
import net.minecraft.client.world.impl.WorldIso;
...
public class CanvasIsomPreview extends Canvas
    ...
    private final java.util.List field_1787_g;
    private final IsoImageBuffer[][] field_1786_h;
    ...
    public static boolean func_1271_a(CanvasIsomPreview canvasisompreview) {
