...
public class TextureWatchFX extends TextureFX {
    ...
    private final Minecraft field_4225_g;
    private final int[] field_4224_h;
    private final int[] field_4223_i;
    ...
    public TextureWatchFX(Minecraft minecraft) {
        ...
        field_1128_f = 1;
        try {
            BufferedImage bufferedimage = ImageIO.read(Objects.requireNonNull((Minecraft.class).getResource("/gui/items.png")));
            int i = (field_1126_b % 16) * 16;
            int j = (field_1126_b / 16) * 16;
            bufferedimage.getRGB(i, j, 16, 16, field_4224_h, 0, 16);
            bufferedimage = ImageIO.read(Objects.requireNonNull((Minecraft.class).getResource("/misc/dial.png")));
