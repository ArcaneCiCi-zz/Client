...
public class NBTTagCompound extends NBTBase {
    ...
    void writeTagContents(DataOutput dataoutput) throws IOException {
        NBTBase nbtbase;
        for (Iterator iterator = tagMap.values().iterator(); iterator.hasNext(); writeTag(nbtbase, dataoutput)) {
    ...
    public String toString() {
        return (new StringBuilder()).append(tagMap.size()).append(" entries").toString();
    }
}
