...
import net.minecraft.client.blocks.impl.BlockMinecartTrack;
import net.minecraft.client.world.World;
import net.minecraft.client.world.chunk.impl.ChunkPosition;
...
public class MinecartTrackLogic {
    ...
    private final int field_1165_c;
    private final int field_1164_d;
    private final int field_1163_e;
    ...
    private void func_789_a() {
        tracks.clear();
        if (field_1162_f == 0) {
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e - 1));
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e + 1));
        } else if (field_1162_f == 1) {
            tracks.add(new ChunkPosition(field_1165_c - 1, field_1164_d, field_1163_e));
            tracks.add(new ChunkPosition(field_1165_c + 1, field_1164_d, field_1163_e));
        } else if (field_1162_f == 2) {
            tracks.add(new ChunkPosition(field_1165_c - 1, field_1164_d, field_1163_e));
            tracks.add(new ChunkPosition(field_1165_c + 1, field_1164_d + 1, field_1163_e));
        } else if (field_1162_f == 3) {
            tracks.add(new ChunkPosition(field_1165_c - 1, field_1164_d + 1, field_1163_e));
            tracks.add(new ChunkPosition(field_1165_c + 1, field_1164_d, field_1163_e));
        } else if (field_1162_f == 4) {
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d + 1, field_1163_e - 1));
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e + 1));
        } else if (field_1162_f == 5) {
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e - 1));
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d + 1, field_1163_e + 1));
        } else if (field_1162_f == 6) {
            tracks.add(new ChunkPosition(field_1165_c + 1, field_1164_d, field_1163_e));
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e + 1));
        } else if (field_1162_f == 7) {
            tracks.add(new ChunkPosition(field_1165_c - 1, field_1164_d, field_1163_e));
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e + 1));
        } else if (field_1162_f == 8) {
            tracks.add(new ChunkPosition(field_1165_c - 1, field_1164_d, field_1163_e));
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e - 1));
        } else if (field_1162_f == 9) {
            tracks.add(new ChunkPosition(field_1165_c + 1, field_1164_d, field_1163_e));
            tracks.add(new ChunkPosition(field_1165_c, field_1164_d, field_1163_e - 1));
        }
    }
    ...
    private void func_785_b() {
        for (int i = 0; i < tracks.size(); i++) {
            MinecartTrackLogic minecarttracklogic = func_795_a((ChunkPosition) tracks.get(i));
            if (minecarttracklogic == null || !minecarttracklogic.func_793_b(this)) {
                tracks.remove(i--);
            } else {
                tracks.set(i, new ChunkPosition(minecarttracklogic.field_1165_c, minecarttracklogic.field_1164_d, minecarttracklogic.field_1163_e));
            }
        }
    ...
    private boolean func_793_b(MinecartTrackLogic minecarttracklogic) {
        for (int i = 0; i < tracks.size(); i++) {
            ChunkPosition chunkposition = (ChunkPosition) tracks.get(i);
    ...
    private boolean func_794_b(int i, int j, int k) {
        for (int l = 0; l < tracks.size(); l++) {
            ChunkPosition chunkposition = (ChunkPosition) tracks.get(l);
    ...
    private boolean func_787_c(MinecartTrackLogic minecarttracklogic) {
        ...
        ChunkPosition chunkposition = (ChunkPosition) tracks.get(0);
    ...
    private void func_788_d(MinecartTrackLogic minecarttracklogic) {
        tracks.add(new ChunkPosition(minecarttracklogic.field_1165_c, minecarttracklogic.field_1164_d, minecarttracklogic.field_1163_e));
    ...
    public void func_792_a(boolean flag) {
        ...
        for (int j = 0; j < tracks.size(); j++) {
            MinecartTrackLogic minecarttracklogic = func_795_a((ChunkPosition) tracks.get(j));
            if (minecarttracklogic == null) {
                continue;
            }
            minecarttracklogic.func_785_b();
