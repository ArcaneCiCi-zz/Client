...
import net.minecraft.client.audio.manager.SoundManager;
...
import net.minecraft.client.entity.player.controller.PlayerController;
import net.minecraft.client.entity.player.controller.PlayerControllerTest;
import net.minecraft.client.entity.player.skin.SkinManager;
import net.minecraft.client.entity.render.EntityRenderer;
import net.minecraft.client.entity.render.RenderGlobal;
import net.minecraft.client.enums.EnumOS2;
import net.minecraft.client.enums.helper.EnumOSMappingHelper;
import net.minecraft.client.gui.impl.*;
import net.minecraft.client.impl.MinecraftImpl;
import net.minecraft.client.item.impl.ItemRenderer;
import net.minecraft.client.item.impl.ItemStack;
import net.minecraft.client.misc.*;
import net.minecraft.client.render.impl.*;
import net.minecraft.client.session.Session;
import net.minecraft.client.setting.GameSettings;
import net.minecraft.client.texture.TexturePackList;
import net.minecraft.client.texture.render.*;
import net.minecraft.client.thread.ThreadDownloadResources;
import net.minecraft.client.thread.ThreadSleepForever;
import net.minecraft.client.ui.LoadingScreenRenderer;
import net.minecraft.client.ui.font.FontRenderer;
import net.minecraft.client.util.MinecraftError;
import net.minecraft.client.util.MinecraftException;
import net.minecraft.client.world.World;
import net.minecraft.client.world.impl.WorldProvider;
import net.minecraft.client.world.impl.WorldProviderHell;
...
public abstract class Minecraft implements Runnable {
    ...
    private final int field_9236_T;
    private final int field_9235_U;
    private final TextureWaterFX field_9232_X;
    private final TextureLavaFX field_9231_Y;
    ...
    @Getter @Setter private static String minecraftName;
    @Getter public static String minecraftArgs;
    ...
    public static File getAppDir(String s) {
        ...
        File file;
        switch (EnumOSMappingHelper.enumInteger[getOs().ordinal()]) {
            case 1:
            case 2:
    ...
    private void checkGLError(String s) {
        ...
        if (i != 0) {
            ...
            System.out.println((new StringBuilder()).append(i).append(": ").append(s1));
            System.exit(0);
        }
    }
        ...
        try {
            ...
            while (running && (mcApplet == null || mcApplet.isActive())) {
                ...
                while (System.currentTimeMillis() >= l + 1000L) {
                    debugInfo = (new StringBuilder()).append(i).append(" fps, ").append(WorldRenderer.field_1762_b).append(" chunk updates").toString();
    ...
    private void func_6254_a(int i, boolean flag) {
        ...
        if (flag && objectMouseOver != null && objectMouseOver.typeOfHit == 0 && i == 0) {
            ...
            field_6327_b.checkAndSendBrokenBlock();
        }
    }
    ...
    public void toggleFullscreen() {
        try {
            ...
            System.out.println((new StringBuilder()).append("Size: ").append(displayWidth).append(", ").append(displayHeight));
        } catch (Exception exception) {
            exception.printStackTrace();
        }
    }
    ...
    public void runTick() {
        ...
        if (currentScreen == null || currentScreen.field_948_f) {
            ...
            do {
                ...
                thePlayer.moveThePlayer(Keyboard.getEventKey(), Keyboard.getEventKeyState());
                    ...
                    if (Keyboard.getEventKey() == 87) {
                        ...
                        if (currentScreen != null) {
                            ...
                            if (Keyboard.getEventKey() == gameSettings.keyBindInventory.keyCode) {
                                displayGuiScreen(new GuiInventory(thePlayer.inventory, thePlayer.inventory.craftingInventory));
                            }
                            ...
                            if (Keyboard.getEventKey() == Keyboard.KEY_SLASH) {
                                GuiChat.isCommand = true;
                                displayGuiScreen(new GuiChat());
                            }

                            if (Keyboard.getEventKey() == Keyboard.KEY_G) {
                                Client.getInstance().getModManager().getTimerModule().toggle();
                            }

                            if (Keyboard.getEventKey() == Keyboard.KEY_H) {
                                Client.getInstance().getModManager().getFullbrightModule().toggle();
                            }

                            if (Keyboard.getEventKey() == Keyboard.KEY_F) {
                                Client.getInstance().getModManager().getFlyModule().toggle();
                            }

                            if (Keyboard.getEventKey() == Keyboard.KEY_X) {
                                Client.getInstance().getModManager().getXrayModule().toggle();
                            }

                            if (Keyboard.getEventKey() == Keyboard.KEY_O) {
                                Client.getInstance().getModManager().getInstantModule().toggle();
                            }
    ...
    public void func_6256_a(World world, String s, EntityPlayer entityplayer) {
        ...
        if (world != null) {
            ...
            thePlayer.movement = new MovementInputFromOptions(gameSettings);
