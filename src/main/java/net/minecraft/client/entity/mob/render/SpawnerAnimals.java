...
import net.minecraft.client.entity.mob.impl.EntitySkeleton;
import net.minecraft.client.entity.mob.impl.EntitySpider;
import net.minecraft.client.enums.EnumCreatureType;
...
public final class SpawnerAnimals {
    ...
    private static final Set eligibleChunksForSpawning = new HashSet();
                                ...
                                for (int var14 = 0; var14 < 3; ++var14) {
                                    ...
                                    for (int var19 = 0; var19 < 4; ++var19) {
                                        ...
                                        if (var0.isBlockOpaqueCube(var15, var16 - 1, var17) && !var0.isBlockOpaqueCube(var15, var16, var17) && !var0.getBlockMaterial(var15, var16, var17).getIsLiquid() && !var0.isBlockOpaqueCube(var15, var16 + 1, var17)) {
                                            ...
                                            if (var0.getClosestPlayer(var20, var21, var22, 24.0D) == null) {
