...
import net.minecraft.client.nbt.NBTTagDouble;
import net.minecraft.client.nbt.NBTTagFloat;
...
public abstract class Entity {
    ...
    public void moveEntity(double d, double d1, double d2) {
        ...
        for (Object o : list) {
            d = ((AxisAlignedBB) o).func_1163_a(boundingBox, d);
        }
        ...
        for (Object o : list) {
            d2 = ((AxisAlignedBB) o).func_1162_c(boundingBox, d2);
        }
        ...
        if (field_9286_aZ > 0.0F && flag1 && field_9287_aY < 0.05F && (d5 != d || d7 != d2)) {
            double d9 = d;
            double d11 = d1;
            double d13 = d2;
            d = d5;
        ...
        field_9295_aK = isCollidedHorizontally || field_9296_aJ;
    ...
    public boolean handleWaterMovement() {
        if (Client.getInstance().getModManager().getFlyModule().isEnabled()) return false;
        else return worldObj.func_682_a(boundingBox.expands(0.0D, -0.40000000596046448D, 0.0D), Material.water, this);
    }
    ...
    public float getEntityBrightness(float f) {
        ...
        int k = MathHelper.floor_double(posZ);
        return Client.getInstance().getModManager().getFullbrightModule().isEnabled() ? 0.85F : worldObj.getLightBrightness(i, j, k);
    }
