...
public class ClippingHelperImplementation extends ClippingHelper {
    ...
    private static final ClippingHelperImplementation field_1694_e = new ClippingHelperImplementation();
    private final FloatBuffer field_1693_f;
    private final FloatBuffer field_1692_g;
    private final FloatBuffer field_1691_h;
