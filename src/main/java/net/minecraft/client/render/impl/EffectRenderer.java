...
import net.minecraft.client.entity.mob.impl.EntityDiggingFX;
import net.minecraft.client.entity.mob.impl.EntityFX;
...
public class EffectRenderer {
    ...
    private final List[] field_1728_b;
    private final RenderEngine field_1731_c;
    ...
    public String func_1190_b() {
        return (new StringBuilder()).append(field_1728_b[0].size() + field_1728_b[1].size() + field_1728_b[2].size()).toString();
    }
}
