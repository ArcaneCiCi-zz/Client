...
public class ScreenShotHelper {
    ...
    private static final DateFormat field_4287_a = new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss");
    ...
    public static String func_4148_a(File file, int i, int j) {
        try {
            ...
            field_4286_b.clear();
            String s = (new StringBuilder()).append(field_4287_a.format(new Date())).toString();
            File file2;
