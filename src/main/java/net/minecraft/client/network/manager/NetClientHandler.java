...
import net.minecraft.client.entity.player.controller.PlayerControllerMP;
import net.minecraft.client.gui.impl.GuiConnectFailed;
import net.minecraft.client.gui.impl.GuiDownloadTerrain;
import net.minecraft.client.item.impl.ItemStack;
import net.minecraft.client.misc.Explosion;
...
import net.minecraft.client.world.impl.WorldClient;
...
public class NetClientHandler extends NetHandler {
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn packet23vehiclespawn) {
        ...
        if (obj != null) {
            ...
            worldClient.func_712_a(packet23vehiclespawn.entityId, obj);
        }
    }
    ...
    public void handleKickDisconnect(Packet255KickDisconnect packet255kickdisconnect) {
        ...
        System.out.println("[Reliant] Username when kicked: " + Minecraft.getMinecraftName());
    }
    ...
    public void handleCollect(Packet22Collect packet22collect) {
        ...
        Object obj = func_12246_a(packet22collect.collectorEntityId);
        if (obj == null) {
            obj = mc.thePlayer;
        }
        if (entity != null) {
    ...
    public void handleHandshake(Packet2Handshake packet2handshake) {
        if (packet2handshake.username.equals("-")) {
            addToSendQueue(new Packet1Login(mc.session.userName, "Password", 6));
        } else {
            try {
                URL url = new URL((new StringBuilder()).append("http://www.minecraft.net/game/joinserver.jsp?user=").append(mc.session.userName).append("&sessionId=").append(mc.session.field_6543_c).append("&serverId=").append(packet2handshake.username).toString());
                ...
                netManager.networkShutdown((new StringBuilder()).append("Internal client error: ").append(exception).toString());
            }
        }
    }
