...
import net.minecraft.client.misc.LogoEffectRandomizer;
...
public class GuiMainMenu extends GuiScreen {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        GL11.glPopMatrix();
        drawString(fontRenderer, "Minecraft Alpha v1.2.6", 2, 2, 0x505050);
    ...
    private void drawLogo(float f) {
        ...
        for (int l = 0; l < 3; l++) {
            ...
            if (l == 0) {
                GL11.glBindTexture(3553, mc.renderEngine.getTexture("/title/black.png"));
            }
            for (int i1 = 0; i1 < minecraftLogo.length; i1++) {
                for (int j1 = 0; j1 < minecraftLogo[i1].length(); j1++) {
                    ...
                    renderblocks.func_1238_a(/*Block.blockGold*/Block.stone, f3);
                    GL11.glPopMatrix();
                }
