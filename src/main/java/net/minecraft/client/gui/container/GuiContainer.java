...
import net.minecraft.client.gui.impl.GuiScreen;
            ...
            if (slot != null) {
                ...
                if (itemstack != null || inventoryplayer.draggingItemStack != null) {
                    if (itemstack != null && inventoryplayer.draggingItemStack == null) {
                        ...
                        } else if (itemstack.itemID == inventoryplayer.draggingItemStack.itemID && inventoryplayer.draggingItemStack.getMaxStackSize() > 1) {
